...
پنل مدیریت IKEv2 / strongSwan برای مدیریت کاربران، سشن‌ها و ترافیک روی سرورهای شخصی و چندسروره. این پروژه را برای ساده‌تر کردن مدیریت VPN و داشتن کنترل بیشتر روی نصب، مانیتورینگ و مهاجرت سرورها توسعه می‌دهم.
...
**ZVPN** روی strongSwan ساخته شده و هدفش این است که کارهای روزمره مدیریت IKEv2—از ساخت کاربر و محدودیت دستگاه تا مشاهده وضعیت اتصال و انتقال سرور—از یک پنل انجام شود.

کلاینت‌های Windows، iOS، macOS و Android/strongSwan در طراحی پروژه در نظر گرفته شده‌اند.

---

## ویژگی‌ها

### مدیریت IKEv2 و strongSwan
